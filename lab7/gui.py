...
class Form:
    ...
    def _init_root(self):
        ...
        self.root.protocol("WM_DELETE_WINDOW", lambda: (self.root.destroy(), plt.close(), self.swap_stop_anim()))
    ...
    def _create_text_boxes(self):
        ...
        # self.textbox_in_cond.insert(0, '0')
        # self.textbox_bound_cond_a.insert(0, '-2')
        # self.textbox_bound_cond_b.insert(0, '1')
    ...
    def swap_stop_anim(self):
        self.stop_anim = not self.stop_anim
